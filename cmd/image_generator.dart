...
void main() async {
  ...
  final file = File('lib/commons/constants/asset/image_resource.dart');
  file.writeAsStringSync('abstract class ImageResource { \n', mode: FileMode.write);
  file.writeAsStringSync('\tconst ImageResource._();\n', mode: FileMode.writeOnlyAppend);
